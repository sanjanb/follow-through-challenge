...
const Tracker = () => {
  ...
  const baselineItems = [
    { id: 'morning', name: 'Morning Routine', icon: '🌅', desc: 'Wake up, make bed, basic hygiene' },
    { id: 'hydration', name: 'Hydration', icon: '💧', desc: 'Drink water throughout the day' },
    { id: 'movement', name: 'Movement', icon: '🏃', desc: 'Exercise or physical activity' },
    { id: 'learning', name: 'Learning', icon: '📚', desc: 'Read, study, or skill practice' },
    { id: 'cleaning', name: 'Cleaning', icon: '🧹', desc: 'Tidy your living space' },
    { id: 'planning', name: 'Planning', icon: '📝', desc: 'Review day, plan tomorrow' },
    { id: 'sleep', name: 'Sleep', icon: '😴', desc: '7-9 hours of quality sleep' }
  ]
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-2xl shadow-soft p-6 md:p-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Daily Tracker</h1>
            <p className="text-gray-600">Day {currentDay + 1} of 28 • Track your baseline habits</p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white rounded-xl shadow-soft p-6 text-center">
          ...
          <div className="text-2xl font-bold text-primary-600">{stats.completedDays}</div>
      ...
      {/* Today's Baseline */}
      <div className="bg-white rounded-2xl shadow-soft p-6 md:p-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Today's Baseline</h2>
      ...
      <div className="bg-white rounded-2xl shadow-soft p-6 md:p-8">
        ...
        <p className="text-gray-600 mb-6">
          What specific accomplishment are you most proud of today? (Even small wins count!)
        </p>
        ...
        <div className="mt-4 text-sm text-gray-500">
          💡 Tip: Specific, measurable accomplishments build momentum and self-trust.
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-soft p-6 md:p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <button
            onClick={() => {
              const allCompleted = state.days[currentDay]?.items?.every(item => item) || false
          ...
          <button
            onClick={() => {
              if (window.confirm('Reset today\'s progress? This cannot be undone.')) {
                updateDay(currentDay, {
