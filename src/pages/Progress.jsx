...
import { TrendingUp, Award, Target, Calendar, CheckCircle, Flame } from 'lucide-react'
...
const Progress = () => {
  ...
  const progressData = Array.from({ length: 28 }, (_, i) => {
    ...
    return {
      ...
      status: completed === 7 ? 'Perfect' : completed > 0 ? 'Partial' : 'Missed'
    }
  })
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white rounded-xl shadow-soft p-6 text-center">
          ...
          <div className="text-3xl font-bold text-primary-600">{stats.completedDays}</div>
      ...
      <div className="bg-white rounded-2xl shadow-soft p-6 md:p-8">
        ...
        <p className="text-gray-600 mb-6">Progress through each week of the challenge</p>
      ...
      <div className="bg-white rounded-2xl shadow-soft p-6 md:p-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Baseline Performance</h2>
        <p className="text-gray-600 mb-6">How consistently you're hitting your daily targets</p>
          ...
          {baselineData.map((item) => (
            <div key={item.name} className="bg-gray-50 rounded-lg p-4">
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-2xl font-bold text-primary-600">{item.rate}%</span>
              </div>
            ...
            {achievements.map((achievement) => (
              ...
              >
                <div className="flex items-center space-x-3">
                  <div className={`text-2xl ${achievement.unlocked ? 'text-green-600' : 'text-gray-400'}`}>
                    {achievement.unlocked ? '🏆' : '🔒'}
                  </div>
